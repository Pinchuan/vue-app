...
var drivingLicenseSearchSuccess = require('modules/drivingLicenseSearch/drivingLicenseSearchSuccess');
...
var comm = Vue.extend({
    ...
    data: function () {
        return {
            ...
            showSuccessDetail:false,//是否显示扫描成功子页面
            // updateNewArr:{}
            //驾驶员行驶证信息
            driverInfo:[{
                title:'行驶证编号',
    ...
    components: {
        'driving-license-search-success':drivingLicenseSearchSuccess
    }
});
module.exports = comm;